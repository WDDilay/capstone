<template>
<div class="p-2 sm:p-4 md:p-6 bg-purple-95 min-h-screen">
  <!-- Header -->
  ...
  <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-6 sm:mb-8">
    <div v-for="(stat, index) in stats" :key="index"
         :class="[
           'rounded-lg sm:rounded-xl shadow-sm p-3 sm:p-4 md:p-6 border border-gray-100 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1',
           index === 0 ? 'bg-blue-100' : '',
           index === 1 ? 'bg-green-100' : '',
           index === 2 ? 'bg-violet-200' : '',
    ...
    <div class="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6 border border-gray-100">
      ...
      <div v-else class="h-64 sm:h-80 md:h-96 relative">
        ...
        <svg class="w-full h-full" :viewBox="isMobile ? '0 0 400 300' : '0 0 900 380'" ref="resourceChartSvg">
          <defs>
            <!-- Gradient definitions for each resource type -->
  ...
  <div class="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
    ...
    <div class="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6 border border-gray-100">
      ...
      <div v-else class="h-64 sm:h-80 md:h-96 relative">
        <!-- Member Registration Line Chart -->
  ...
  <!-- Recent Attendance Forms Table -->
  <div class="bg-purple-95 rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6 border border-gray-100 mb-6 sm:mb-8">
    <div class="bg-purple-95 flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 space-y-3 sm:space-y-0">
      <div>
...
{ 
  ...
  icon: Users,
  bgColor: 'bg-gradient-to-br from-blue-500 to-blue-500',
...
{ 
  ...
  icon: Package,
  bgColor: 'bg-gradient-to-br from-green-500 to-green-500',
  trend: 0
},
{ 
  ...
  icon: MessageSquare,
  bgColor: 'bg-gradient-to-br from-violet-500 to-violet-500',
  trend: 0
},
{ 
  ...
  icon: Bell,
  bgColor: 'bg-gradient-to-br from-orange-500 to-orange-500',
  trend: 0
}
]);
